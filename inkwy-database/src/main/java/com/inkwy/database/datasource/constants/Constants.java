...
public final class Constants {
    ...
    public static final String INCR_FIELD_START_VALUE = "_start_value";
    public static final String INCR_FIELD_END_VALUE = "_end_value";

    public static final String WRITEMODE_INSERT = "insert";

    public static final String ONE_CONFIG_TYPE = "one";
    public static final String ALL_CONFIG_TYPE = "all";
}
