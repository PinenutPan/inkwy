...
public enum DBUtilErrorCode implements ErrorCode {
    ...
    AWS_CONN_DB_ERROR("DBUtilErrorCode-10", "AWS连接失败. 请检查您的 accessId、accessKey、endpoint、bucket或者向 IT管理员 寻求帮助(注意网络环境)."),
    FTP_CONN_DB_ERROR("DBUtilErrorCode-10", "FTP连接失败. 请检查您的 账号、密码、IP、Port或者向 IT管理员 寻求帮助(注意网络环境)."),
