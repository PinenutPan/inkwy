...
public class AESUtil {
    ...
    private static KeyGenerator getKeyGenerator(String key) {
        ...
        try {
            ...
            log.error("Get key generator error", e);
        }
    ...
    public static String encrypt(String message, String key) {
        try {
            ...
            log.error("content encrypt error", e);
        }
        return null;
    }
    ...
    public static String decrypt(String ciphertext, String key) {
        try {
            ...
            log.error("content decrypt error", e);
        }
        return null;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("加密后密文为: " + ciphertext + ",长度" + ciphertext.length());
